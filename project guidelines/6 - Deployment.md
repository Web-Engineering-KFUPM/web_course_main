...
| **Live URL Submission (10)** | Live URL is submitted and accessible without errors. | Live URL is submitted and accessible with minor issues. | Live URL is submitted but has noticeable errors or is inaccessible at times. | Live URL is submitted but is largely inaccessible or error-prone. | Live URL is not submitted or is completely inaccessible. |